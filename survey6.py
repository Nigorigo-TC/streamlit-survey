...
if not is_admin:
    ...
    if not st.session_state["submitted"]:
        ...
        st.caption("※ 昨日の運動がどれくらいきつかったか（主観評価）")
