...
if not is_admin:
    ...
    if not st.session_state["submitted"]:
        ...
        st.caption("※ 主観的に感じた昨日の運動のきつさをRPEスケールで評価")
